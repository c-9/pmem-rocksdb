...
ImmutableDBOptions::ImmutableDBOptions(const DBOptions& options)
    : create_if_missing(options.create_if_missing),
...
#ifdef ON_DCPMM
      allow_dcpmm_writes(options.allow_dcpmm_writes),
      recycle_dcpmm_sst(options.recycle_dcpmm_sst),
#endif
      ...
      #ifdef ON_DCPMM
      , dcpmm_kvs_enable(options.dcpmm_kvs_enable),
      dcpmm_kvs_level(options.dcpmm_kvs_level),
